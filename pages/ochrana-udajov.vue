  ...
  <div>
    ...
    <section class="pt-32 pb-16 bg-gradient-to-br from-black to-neutral-800 text-white">
      <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-neutral-300">Informácie o spracovaní vašich osobných údajov</p>
      </div>
    </section>
      ...
      <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
          <div class="card-elegant p-8 md:p-12 prose prose-neutral max-w-none">
            <h2 class="font-serif text-2xl font-bold text-neutral-900 mb-4">1. Prevádzkovateľ</h2>
            ...
            <h2 class="font-serif text-2xl font-bold text-neutral-900 mb-4">2. Účel spracovania</h2>
            <p class="text-neutral-700 mb-6">
            ...
            <h2 class="font-serif text-2xl font-bold text-neutral-900 mb-4">3. Rozsah údajov</h2>
            <p class="text-neutral-700 mb-6">
              Spracovávame nasledovné kategórie osobných údajov: meno, priezvisko, 
              telefónne číslo, e-mailová adresa.
            </p>

            <h2 class="font-serif text-2xl font-bold text-neutral-900 mb-4">4. Doba uchovávania</h2>
            <p class="text-neutral-700 mb-6">
            ...
            <h2 class="font-serif text-2xl font-bold text-neutral-900 mb-4">5. Vaše práva</h2>
            ...
            <h2 class="font-serif text-2xl font-bold text-neutral-900 mb-4">6. Kontakt</h2>
